...
def buscar_google_jurisprudencia(query: str) -> str:
    ...
    try:
        ...
        # Trocamos 'Google Search' pelo comando correto 'Google Search'
...
class AgenteTecnicoContrato:
    def __init__(self, llm_api_key):
        ...
        react_prompt_template = """Você é um advogado sênior, especialista em Direito Contratual. Sua missão é analisar os dados de um contrato e, usando as ferramentas, definir a fundamentação jurídica.
        Você tem acesso às seguintes ferramentas:
        
        {tools}
        
        Para usar uma ferramenta, siga o formato de Ação. Os nomes exatos das ferramentas que você pode usar são: {tool_names}
        ...
        ```json
        {{"fundamentos_legais": [{{"lei": "Código Civil", "artigos": "Art. 421 e 422", "descricao": "Princípios da função social do contrato e da boa-fé objetiva."}}], "principios_juridicos": ["Pacta Sunt Servanda", "Boa-Fé Objetiva"], "jurisprudencia_relevante": "Cite uma súmula ou resumo de decisão encontrada com a ferramenta.", "analise_juridica_detalhada": "Análise concisa explicando como o contrato será regido pelos princípios e leis encontrados."}}
        ```
        Comece!
