# orquestrador.py - Versão Final com Fluxo Dedicado para Pesquisa de Jurisprudência
...
# COMENTÁRIO: Importamos os novos agentes para a pesquisa de jurisprudência.
...
class OrquestradorPrincipal:
    ...
    def processar_solicitacao_completa(self, dados_entrada: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            # COMENTÁRIO: Adicionado um novo fluxo "cirúrgico" apenas para a pesquisa de jurisprudência.
            # Se o tipo de documento for este, ele executa um fluxo simplificado e termina.
